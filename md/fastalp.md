...
[fastalp](https://crates.io/crates/fastalp) · [GitHub](https://github.com/webc-site/fastalp) · [Docs](https://docs.rs/fastalp)

A pure-Rust algorithmic evolution of the ALP (Adaptive Lossless Floating-Point) compression paradigm, engineered for high-throughput time-series, telemetry, and columnar storage engines.
